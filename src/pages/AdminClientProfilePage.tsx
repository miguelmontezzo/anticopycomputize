...
export default function AdminClientProfilePage() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-5xl mx-auto">
      ...
      {tab === 'Portal' && (
        <Card>
          <div className="text-sm font-semibold text-gray-900 mb-1">Portal do Cliente</div>
          <p className="text-sm text-gray-500 mb-4">
            Em breve: ative o acesso do cliente ao portal para aprovação de calendários e visualização de conteúdos.
          </p>
          {slug && (
            <div className="flex items-center gap-2 bg-gray-50 border border-gray-100 rounded-lg px-3 py-2 text-xs text-gray-600">
              <Globe className="w-3.5 h-3.5" />
              <span>{origin}/portal/{slug}</span>
            </div>
          )}
          <div className="mt-4">
            <Badge variant="pending">Em desenvolvimento — Fase 3</Badge>
          </div>
        </Card>
      )}
